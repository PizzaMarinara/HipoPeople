...
data class UserReposGithubDto(
    ...
    val fullName: String,
    val private: Boolean,
    val owner: UserReposOwnerGithubDto,
    @Json(name = "html_url")
    val htmlUrl: String,
    ...
    val license: UserReposLicenseGithubDto,
...
fun UserReposGithubDto.toGithubRepositoryDetails(): GithubRepositoryDetails {
